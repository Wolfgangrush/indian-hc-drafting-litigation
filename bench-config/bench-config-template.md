...
3. **Verify each value against your bench's Practice Notes / Registry directions / Civil Manual.** If unsure, leave the default (which is the Bombay HC value) and ask the Registry at filing.
